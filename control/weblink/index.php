...
if($ModuleAction == "AddForm"){
	...
	$sql = "select *  from weblink where id = '$ModuleDataID'";
...
<div class="control-group">
<label class="control-label request"  for="url_name">* URL</label>
<div class="controls">
<input type="text" id="url_name" name="url_name" class="input-xxlarge request " value="<?=$Row["urladdress"]?>" >
</div>
</div>
...
<div class="controls">
			...
			$ObjUFileID="OnePic";
			$ObjUFileType="onepic";
			$img="../../uploads/weblinks/".$Row["filepic"];
