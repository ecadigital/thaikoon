...
<div class="clearfix">
<a href="category.php" class="btn" ><i class="icon-chevron-left"></i>Back</a>
...
<a id="btn_add" class="btn btn-success" data-toggle="modal" href="category-action.php?<?=SystemEncryptURL("ModuleAction=AddForm")?>"><i class="icon-plus"></i> Add New Category</a>

<a  class="btn"  href="category.php?<?=SystemEncryptURL("ModuleAction=SortForm")?>"><i class="icon-plus"></i><?=_Store_Cateory_Sorting_?></a>
<div class="line-control-header"></div>
</div>
<br>
