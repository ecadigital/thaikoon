...
<div style="float:left; height:100px; display:inline-block">
 <img data-src="../js/holder.js/80x80" class="img-polaroid">
 </div>

<div style="width:100%; font-weight:bold; float:left; display:inline-block">
<?=$_SESSION['LANG']?> : <?=$_SESSION['UserFname']?> <?=$_SESSION['UserLname']?>
</div>
