...
<li class=""><a href="index.php?<?=SystemEncryptURL("SysMenuID=$SysMenuID")?>" >FAQs List</a></li>
<li class="active"><a href="category.php?<?=SystemEncryptURL("SysMenuID=$SysMenuID")?>" >Category</a></li>
</ul>
...
<?
	...
	for ($i=0;$i<$CntRecInPage;$i++) {
		...
		$Row = $ContentList[$i];
		$sql1 = "SELECT count(*) as CNT FROM faq_category ";
