...
if($ModuleAction == "AddForm"){
	...
	$statusShowHome=$Row["flag_showhome"];
...
<script>
  ...
  <div class="control-group">
<label class="control-label" for="statusShowHome">สถานะแสดงผลหน้าแรก</label>
<div class="controls">

  <input class="icheckbox" id="statusShowHome" name="statusShowHome" type="checkbox" value="Y" <? if($statusShowHome=="Y"){?>checked<? } ?> > &nbsp; แสดงผลหน้าแรก
