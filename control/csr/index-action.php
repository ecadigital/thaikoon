...
<? if($Row["flag_showhome"]=="Y"){?>
<span class="label label-success">แสดงผลหน้าแรก</span>
<? } ?>
</td>
...
<?
	...
	if($input_fileIDOnePicHome!=""){
		...
		if($_REQUEST["statusShowHome"]=="Y"){
			
			$Conn->execute("update  article_main set flag_showhome='N' where menu_id = '".$_REQUEST['SysMenuID']."'");
			
			$flag_showhome="Y";
		}else{
			$flag_showhome="N";
		}
		$insert["flag_showhome"] 			= "'".$flag_showhome."'";
...
<? 
	...
	$update[] = "flag_showhome 		= '".$flag_showhome."'";
