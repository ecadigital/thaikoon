<?
	...
	define("_DATABASE_USERNAME_",'digitgood_tcoon');
	define("_DATABASE_PASSWORD_",'thaicoon2014+');
	define("_DATABASE_NAME_",'digitgood_tcoon');
	// Upload
	define("_SYSTEM_HOST_NAME_","http://".$_SERVER["SERVER_NAME"]."/thaikoon");
	...
	define("_FRONT_URLFULL_PATH_","http://".$_SERVER["SERVER_NAME"]."/thaikoon");
	//define("_FRONT_PATH_","../");
