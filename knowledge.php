					...
					for ($i=0;$i<$CntRecInPage;$i++) {
						...
						?>
					    		 ...
					    		 <li>
					    		   <div class="bl1">
					    		     <div class="plus"></div>
					    		     <a href="knowledge-detail.php?did=<?=$Row["id"]?>"> <img src="<?=$physical_name?>"></a> </div>
					    		   <!--bl1-->
							    		 
							    		 
						    		   <div class="bl2">
								    		 <span><?=$date?></span>
								    		 <strong><a href="knowledge-detail.php?did=<?=$Row["id"]?>"><?=$Row["name"]?></a></strong>
								    		 <p><?=$content_html?></p>
							    		 </div>
							    		 <!--bl2-->
